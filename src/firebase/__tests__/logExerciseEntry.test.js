...
describe('Exercise Logging Service', () => {
  ...
  describe('saveWorkoutLog', () => {
    ...
    it('should throw error when userId is missing', async () => {
      ...
      await expect(saveWorkoutLog(mockLogObject)).rejects.toThrow('User ID is required to save a workout log.')
    })
    ...
    it('should handle Firebase errors', async () => {
      ...
      await expect(saveWorkoutLog(mockLogObject)).rejects.toThrow('Firebase error')
    })
    ...
    it('should call collection with correct path', async () => {
      ...
      expect(collection).toHaveBeenCalledWith({}, 'users', 'test-user-id', 'workoutLog')
    })
  })
}) 