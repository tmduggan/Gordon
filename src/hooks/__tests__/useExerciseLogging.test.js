...
describe('useExerciseLogging', () => {
  ...
  describe('handleSelect', () => {
    it('should add exercise to cart and set initial log data', () => {
      const { result } = renderHook(() => 
        useExerciseLogging(mockExerciseLibrary, mockExerciseHistory, mockCart, mockSearch, mockDateTimePicker)
      )
    ...
    it('should not call clearSearch if search is not provided', () => {
      const { result } = renderHook(() => 
        useExerciseLogging(mockExerciseLibrary, mockExerciseHistory, mockCart, null, mockDateTimePicker)
      )
  ...
  describe('logCart', () => {
    ...
    it('should handle errors during logging', async () => {
      const { saveWorkoutLog } = await import('../../firebase/firestore/logExerciseEntry')
  ...
  describe('cartProps', () => {
    ...
    it('should update log data when onLogDataChange is called', () => {
      ...
      expect(result.current.cartProps.logData['bench-press']).toEqual(newLogData)
    })
  })
}) 