            ...
            <CardContent className="pt-0">
                <div className="grid grid-cols-2 gap-4 text-sm">
                    <div className="space-y-2">
                        ...
                        <div className="pl-6">
                            <div className="text-lg font-bold">{formatValue(bests.current)}</div>
                            <div className="text-xs text-gray-500">{formatDate(bests.current?.date)}</div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="pl-6">
                            <div className="text-lg font-bold">{formatValue(bests.quarter)}</div>
                            <div className="text-xs text-gray-500">{formatDate(bests.quarter?.date)}</div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="pl-6">
                            ...
                            <div className="text-xs text-gray-500">{formatDate(bests.year?.date)}</div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="pl-6">
                            <div className="text-lg font-bold">{formatValue(bests.allTime)}</div>
                            <div className="text-xs text-gray-500">{formatDate(bests.allTime?.date)}</div>
                        </div>
                    </div>
                </div>
            </CardContent>
