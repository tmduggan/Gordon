...
describe('ExerciseDisplay', () => {
  ...
  it('should render instructions when showInstructions is true', () => {
    ...
    expect(
      screen.getByText('Lie on bench and press barbell')
    ).toBeInTheDocument();
  });
  ...
  it('should not render instructions when showInstructions is false', () => {
    ...
    expect(
      screen.queryByText('Lie on bench and press barbell')
  ...
  it('should handle exercise without equipment', () => {
    ...
    render(
      <ExerciseDisplay {...mockProps} exercise={exerciseWithoutEquipment} />
    );
  ...
  it('should handle exercise without category', () => {
    ...
    render(
      <ExerciseDisplay {...mockProps} exercise={exerciseWithoutCategory} />
    );
  ...
  it('should handle exercise without secondary muscles', () => {
    ...
    render(
      <ExerciseDisplay {...mockProps} exercise={exerciseWithoutSecondary} />
    );
