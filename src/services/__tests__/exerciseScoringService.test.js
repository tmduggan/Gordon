...
describe('Exercise Scoring Service', () => {
  ...
  describe('addWorkoutToMuscleReps', () => {
    it('should add reps to target muscle', () => {
      const result = addWorkoutToMuscleReps(mockWorkoutData, mockExerciseDetails, mockMuscleReps)
    ...
    it('should handle single rep value', () => {
      ...
      const result = addWorkoutToMuscleReps(workoutWithReps, mockExerciseDetails, mockMuscleReps)
    ...
    it('should handle empty muscle reps', () => {
      const result = addWorkoutToMuscleReps(mockWorkoutData, mockExerciseDetails, {})
    ...
    it('should handle array of secondary muscles', () => {
      ...
      const result = addWorkoutToMuscleReps(mockWorkoutData, exerciseWithArray, mockMuscleReps)
    ...
    it('should handle no sets or reps', () => {
      const emptyWorkout = {}
      const result = addWorkoutToMuscleReps(emptyWorkout, mockExerciseDetails, mockMuscleReps)
  ...
  describe('calculatePersonalBestBonus', () => {
    ...
    it('should return 4 for all-time best', () => {
      ...
      const result = calculatePersonalBestBonus(workoutWithRecord, mockExerciseDetails, mockUserProfile)
    ...
    it('should return 0 for no improvement', () => {
      ...
      const result = calculatePersonalBestBonus(workoutNoRecord, mockExerciseDetails, mockUserProfile)
      expect(result).toBe(0)
    })

    it('should handle missing personal bests', () => {
      const result = calculatePersonalBestBonus(mockWorkoutData, mockExerciseDetails, {})
      expect(result).toBe(0)
    })

    it('should handle workout without sets', () => {
      const workoutNoSets = { duration: 30 }
      const result = calculatePersonalBestBonus(workoutNoSets, mockExerciseDetails, mockUserProfile)
      expect(result).toBe(0)
    })
  })
}) 